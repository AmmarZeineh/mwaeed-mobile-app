...
### Stripe
Move the publishable key out of source code.

Replace `lib/app_keys.dart` with environment-based access:
...
Run:
```bash
flutter run --dart-define=STRIPE_PUBLISHABLE_KEY=YOUR_KEY
```

### Firebase
This project uses `firebase_options.dart` (generated by FlutterFire). Ensure your Firebase project is configured for Android/iOS.
